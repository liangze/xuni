        ...
        public List<lgk.Model.tb_goods> DataTableToList(DataTable dt)
        {
            ...
            if (rowsCount > 0)
            {
                ...
                for (int n = 0; n < rowsCount; n++)
                {
                    ...
                    if (dt.Rows[n]["IsHave"] != null && dt.Rows[n]["IsHave"].ToString() != "")
                    {
                        model.IsHave = int.Parse(dt.Rows[n]["IsHave"].ToString());
                    }
                    ...
                    {
                        model.Goods003 = dt.Rows[n]["Goods003"].ToString();
                    }
                    ...
                    {
                        model.Goods006 = decimal.Parse(dt.Rows[n]["Goods006"].ToString());
                    }
