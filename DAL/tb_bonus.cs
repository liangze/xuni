...
new SqlParameter("@ID", SqlDbType.BigInt)
        ...
        public long Add(lgk.Model.tb_bonus model)
        {
            ...
            strSql.Append("SourceEn,SttleTime,FromUserID,Bonus001,Bonus002,Bonus003,Bonus004,Bonus005,Bonus006,Bonus007,UserID,Batch,TypeID,Amount,Revenue,sf,AddTime,IsSettled,Source");
            ...
            parameters[0].Value = model.SourceEn;
            parameters[1].Value = model.SttleTime;
            ...
            parameters[6].Value = model.Bonus004;
            parameters[7].Value = model.Bonus005;
            parameters[8].Value = model.Bonus006;
            parameters[9].Value = model.Bonus007;
            parameters[10].Value = model.UserID;
            parameters[11].Value = model.Batch;
            parameters[12].Value = model.TypeID;
            parameters[13].Value = model.Amount;
            parameters[14].Value = model.Revenue;
            parameters[15].Value = model.sf;
            parameters[16].Value = model.AddTime;
            parameters[17].Value = model.IsSettled;
