...
* @params   暂无
*/
$.fn.BankCity = function() {
    var _self = this;
    //定义3个默认值
    var $pvalue1 = document.getElementById("bank1");
    _self.data("province", [$pvalue1.value == "" ? "请选择" : $pvalue1.value, $pvalue1.value == "" ? "请选择" : $pvalue1.value]);
    var $pvalue2 = document.getElementById("bank2");
    _self.data("city1", [$pvalue2.value == "" ? "请选择" : $pvalue2.value, $pvalue2.value == "" ? "请选择" : $pvalue2.value]);
    //	_self.data("province",["请选择", "请选择"]);
    //	_self.data("city1",["请选择", "请选择"]);
    //	_self.data("city2",["请选择", "请选择"]);
    //插入3个空的下拉框
    _self.append("<select></select>省");
    _self.append("<select></select>市");
    //	_self.append("<select></select>区/县");
    //分别获取3个下拉框
