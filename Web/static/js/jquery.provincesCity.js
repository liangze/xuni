...
$.fn.ProvinceCity = function(){
	var _self = this;
	//定义3个默认值
	var $pvalue1 = document.getElementById("sheng");
	_self.data("province", [$pvalue1.value == "" ? "请选择" : $pvalue1.value, $pvalue1.value == "" ? "请选择" : $pvalue1.value]);
	var $pvalue2 = document.getElementById("shi");
	_self.data("city", [$pvalue2.value == "" ? "请选择" : $pvalue2.value, $pvalue2.value == "" ? "请选择" : $pvalue2.value]);
