                        ...
                        <div class="subMIdTxt">
                            ...
                            <div class="subMidInfo subMidColor">
                                <dl>
                                    ...
                                    <dd>消费级别：<%if(dengji==0)  %> 
                                       <%  {%>
                                        <%=LoginUser.LevelID>LoginUser.User017?levelBLL.GetLevelName(LoginUser.LevelID):levelBLL.GetLevelName(Convert.ToInt32(LoginUser.User017)) %> 
                                      <%  }%>
                                       <% else  %> 
                                        <%  {%>
                                        <%=rongyu(dengji) %>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget-box">
                        <div style="height:30px;margin-top:12px;margin-left:20px;"><a href="member/NoticeList.aspx">更 多>> <%--<img src="../images/more.jpg" />--%></a></div>
