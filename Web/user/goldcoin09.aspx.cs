...
namespace Web.user
{
    public partial class goldcoin09 : PageCore//System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                txtBonusAccount.Value = LoginUser.User012.ToString();
                BindData();
            }
        }
        private string GetWhere()
        {
            string strWhere = string.Format("u.UserID=" + getLoginID() + "AND JournalType=9");
