...
{
    public partial class Paydown : PageCore
    {
        int iRechargeID = 0;

        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request["RechargeID"] != null && Request["RechargeID"].Length > 0)
            {
                //if (PageValidate.IsInteger(Request["RechargeID"]))
                //{
                    iRechargeID = Convert.ToInt32(Request["RechargeID"].ToString());
                //}
            }
            else
            {
