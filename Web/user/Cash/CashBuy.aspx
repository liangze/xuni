<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cashbuy.aspx.cs" Inherits="Web.user.Cash.Cashbuy" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="right_content">
            <h2><%=GetLanguage("ConsignmentInfo")%></h2>
            <div class="filter">
                <div class="row-fluid">
                    <p class="span3">
                    ...
                    <p class="span3">
                        ...
                        <span class="field">
                            <%if (GetLanguage("LoginLable") == "zh-cn")
                              {%>
                            <asp:TextBox ID="txtEnd" tip="发布时间" runat="server" onfocus="WdatePicker()"></asp:TextBox>
                            <%}
                              else
                              {%>
