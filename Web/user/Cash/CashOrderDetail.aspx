<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashOrderDetail.aspx.cs" Inherits="Web.user.Cash.CashOrderDetail" %>
        ...
        <div class="right_content">
            ...
            <div class="row-fluid">
                <div class="span6">
                    ...
                    <div class="control-group">
                        <label for="memid">
                            <%=GetLanguage("BankAccount")%><%--买家银行帐号--%>：
                        </label>
                        <div class="field">
                    ...
                    <div class="control-group">
                        <label for="memid">
                            <%=GetLanguage("AccountName")%><%--买家银行姓名--%>：
                        </label>
                        <div class="field">
                    ...
                    <div class="control-group">
                        <label for="memid">
                            <%=GetLanguage("BankBranch")%><%--买家开户网点--%>：
                        </label>
                        <div class="field">
                            <asp:Literal ID="ltBBankBranch" runat="server"></asp:Literal>
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="memid">
                        ...
                        <div class="field">
                            <asp:Literal ID="ltBQQnumer" runat="server"></asp:Literal>
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="memid">
                            <%=GetLanguage("ContactPhone")%><%--买家手机号码--%>：
                        </label>
                        <div class="field">
                    ...
                    <div class="control-group">
                        <label for="memid">
                            <%=GetLanguage("BuyersRating")%><%--买家信誉等级--%>：
                        </label>
                        <div class="field">
