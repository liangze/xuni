...
namespace Web.user
{
    public partial class goldcoin08 : PageCore//System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                txtBonusAccount.Value = LoginUser.User011.ToString();
                BindData();
            }
        }
        private string GetWhere()
        {
            string strWhere = string.Format("u.UserID=" + getLoginID() + "AND JournalType=8");
