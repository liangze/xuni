<%@ Page Title="" Language="C#" MasterPageFile="~/user/shop/Index.Master" AutoEventWireup="true" CodeBehind="js.aspx.cs" Inherits="Web.user.shop.js" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pre_box w">
                ...
                <table id="JS_cart_table" class="cart_table">
                    <tbody>
                        <tr>
                            ...
                            <th style="width: 8%">Bv</th>
                            <th style="width: 10%">总Bv</th>
                        </tr>
                    </tbody>
                            ...
                            <tbody id="JS_shop_list_1" class="shop_list" data-shop_id="1">
                                <tr id="JS_goods_list_11131779" data-rec="11131779" class="goods_list" data-goods_id="24189" data-act_id="0" data-goods_type="0" data-auction_id="0">
                                    ...
                                    <%}
                                       ...
                                       { %>
                                    <td class="yen">¥<%# Eval("ShopPrice")%><div class="goods_install_fee goods_install_single" style="display: none;"></div>
                                    </td>
                                    <%} %>
        ...
        <div class="cart_extra" style="border: none; width: 1130px;">
            <div class="clearfix">
                <div class="Right r">
                    <span class="gray f14">产品金额共计：
                                                    ¥<asp:Label class="yen" ID="JS_goods_total" runat="server" Text=""></asp:Label>
                    </span>
                    <br>
                    <br>
                    优惠：<span class="red yen f14" id="JS_activity_fee"><%=GetUserLev()=="10"?"0":GetUserLev()%>折</span>
                    <br>
                    <div id="JS_gift_goods" class="r red"></div>
                    <span class="f14 bt mt10"><b>应付总额</b>：
            ...
            <%--<div class="clearfix" >
				...
				<span class="gray f14">产品积分共计：<!--<span class="yen" id="Span1">¥3988</span>-->
								...
								优惠：<span class="red yen f14" id="Span2"><%=GetUserLev()=="10"?"0":GetUserLev()%>折</span><br>
				
				<div id="Div1" class="r red"></div>
				<span class="f14 bt mt10"><b>应付消费金</b>：<!--<span class="red yen total_price" id="Span3">¥3988</span>-->
    ...
    <script language="javascript">
        function chkPayMode(f) {
            ...
            $("#<%=JS_submit_form.ClientID%>").css({ "display": "none" });
