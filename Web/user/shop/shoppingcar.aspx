<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shoppingcar.aspx.cs" Inherits="Web.user.shop.shoppingcar" %>
...
<head runat="server">
  ...
  <%--  <meta http-equiv="X-UA-Compatible" content="IE=7" />--%>
    <title>
        <%=GetLanguage("ShoppingCart")%></title>
                        ...
                        <ContentTemplate>
                            <div class="operating">
                                <div style="height: 30px;">
                                    ...
                                    <%-- 订货总金额：--%><strong><asp:Label ID="lilMoney" ForeColor="Red" runat="server" Text=""></asp:Label></strong>&nbsp;<%=GetLanguage("USD")%><%=GetLanguage("OrderScores")%>:
