<%@ Page Title="" Language="C#" MasterPageFile="~/user/shop/Index.Master" AutoEventWireup="true" CodeBehind="miaoshaList.aspx.cs" Inherits="Web.user.shop.miaoshaList" ValidateRequest="false" %>
    ...
    <div id="tuan_container" class="w">
        <div class="tg_pos">
            <span class="pos_icon"></span><a href="default.aspx" class="pos_in">首页</a> <span
                ...
                &gt;<span> <a href="tuangou.aspx">团购</a> </span>
                &gt;<span> <a href="xianshiqianggou.aspx" >限时抢购</a> </span>
                &gt;<span> <a href="miaoshaList.aspx" style=" color:Red;">秒杀</a> </span>
        ...
        <div class="tuan_serch">
            <div class="tuan_serch_t">
                <h3 class="Left">
                    商品筛选：</h3>
                <a href="miaoshaList.aspx" class="Right">显示全部商品</a>
            </div>
            <div id="result">
            </div>
