<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TreeList.aspx.cs" Inherits="Web.user.team.TreeList" %>
...
<head id="Head1" runat="server">
    <title></title>
    <link rel="stylesheet" type="text/css" href="../../admin/Content/base.css" />
    <link rel="stylesheet" type="text/css" href="../../admin/Content/themes/default/easyui.css" />
    <link rel="stylesheet" type="text/css" href="../../admin/Content/themes/icon.css" />
...
<body>
    ...
    <div class="capositon">
        当前位置：会员中心>><a href="javascript:void(0)"><%=string.IsNullOrEmpty(Request.QueryString["a"])?"系谱图":"直推图" %></a></div>
    <div class="operation">
