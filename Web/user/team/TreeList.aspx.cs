...
{
    public partial class TreeList : PageCore//System.Web.UI.Page
    {
        ...
        private void bind2()
        {
            ...
            string strSql = "SELECT * FROM dbo.tb_user WHERE '-'+CAST(UserPath AS NVARCHAR(max))+'-' LIKE '%-" + iUID + "-%' " + getWhere2();
            if (!string.IsNullOrEmpty(a))
            {
                strSql = "SELECT * FROM dbo.tb_user WHERE '-'+CAST(RecommendPath AS NVARCHAR(max))+'-' LIKE '%-" + iUID + "-%' " + getWhere2();
            }
