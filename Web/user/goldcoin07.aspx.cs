...
namespace Web.user
{
    public partial class goldcoin07 : PageCore// System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                txtBonusAccount.Value = LoginUser.GLmoney.ToString();
                BindData();
            }
        }
        private string GetWhere()
        {
            string strWhere = string.Format("u.UserID=" + getLoginID() + "AND JournalType=6");
