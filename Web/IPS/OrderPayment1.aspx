<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderPayment1.aspx.cs" Inherits="Web.IPS.OrderPayment1" %>
    ...
    <div class="site">
       ...
       <div style="padding:10px; line-height:20px;">
           <%=ConfirmHtml %>
            ...
            <div>
                <input type="hidden" name="test" id="txtusercode" value="" runat="server"/>
