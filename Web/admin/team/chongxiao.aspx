<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chongxiao.aspx.cs" Inherits="Web.admin.team.chongxiao" %>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" 
                        ...
                        <ItemTemplate>
                            <tr>
                               ...
                               <td align="center">
                                    <asp:LinkButton ID="LinkButton1" CommandArgument='<%# Eval("UserID") %>' CommandName="Open" class="easyui-linkbutton"   
                    iconcls="icon-edit"   runat="server">修改</asp:LinkButton>
                               </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
