                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center">
                             ...
                             <td align="center">
                                 <asp:Label ID="Label1" runat="server" Text=' <%#decimal.Parse(Eval("RightNewScore").ToString()) >= decimal.Parse(Eval("LeftNewScore").ToString())? Rongyu(decimal.Parse(Eval("RightNewScore").ToString())):Rongyu(decimal.Parse(Eval("LeftNewScore").ToString()))%>'></asp:Label>
