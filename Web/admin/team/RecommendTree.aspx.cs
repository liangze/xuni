...
namespace Web.admin.team
{
    public partial class RecommendTree : AdminPageBase//System.Web.UI.Page
    {
        ...
        public TreeNode getTree(long uid)
        {
            ...
            {
                dd = "[已开通]  [左区总业绩]" + userInfo.LeftScore + "[右区总业绩]" + userInfo.RightScore + "[左新业绩]" + userInfo.LeftNewScore + "[右新业绩]" + userInfo.RightNewScore;  
            }

            if (uid == 1)
            {
                node.Text = userInfo.UserCode+"  [左区总业绩]"+ userInfo.LeftScore+ " [右区总业绩]"+ userInfo.RightScore + " [左新业绩]"+ userInfo.LeftNewScore + " [右新业绩]"+ userInfo.RightNewScore;
