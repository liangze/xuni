                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <asp:LinkButton ID="LinkButton2" runat="server" CommandName="er" CommandArgument='<%#Eval("UserID")%>'
                                    class="easyui-linkbutton" iconcls="icon-ok" Visible='<%#Convert.ToInt32(Eval("LevelID"))!=1?true:false %>'>一星级别</asp:LinkButton>
                                <asp:LinkButton ID="LinkButton3" runat="server" CommandName="san" CommandArgument='<%#Eval("UserID")%>'
                                    class="easyui-linkbutton" iconcls="icon-ok" Visible='<%#Convert.ToInt32(Eval("LevelID"))!=2?true:false %>'>二星级别</asp:LinkButton>
                                <asp:LinkButton ID="LinkButton4" runat="server" CommandName="si" CommandArgument='<%#Eval("UserID")%>'
                                    class="easyui-linkbutton" iconcls="icon-ok" Visible='<%#Convert.ToInt32(Eval("LevelID"))!=3?true:false %>'>三星级别</asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
