...
<body>
    ...
    <div class="operation">
        <asp:LinkButton ID="LinkButton1" runat="server" class="easyui-linkbutton" iconcls="icon-search"
            OnClick="LinkButton1_Click"> 申请记录 </asp:LinkButton>
        <asp:LinkButton ID="LinkButton2" runat="server" class="easyui-linkbutton" iconcls="icon-search"
            OnClick="LinkButton2_Click"> 提现记录 </asp:LinkButton>
    </div>
    <div class="operation">
        <fieldset class="fieldset">
            ...
            会员编号：<input name="Add_sscFd7" id="txtUserCode2" tip="输入会员编号" class="input_select"
                runat="server" type="text" />
            会员姓名：<input name="Add_sscFd7" id="txtTrueName" tip="输入会员姓名" class="input_select"
                runat="server" type="text" />
            申请日期：<asp:TextBox ID="textStar" tip="输入提现日期" runat="server" onfocus="WdatePicker()"
                class="input_select"></asp:TextBox>
            至<asp:TextBox ID="textEnd" tip="输入提现日期" runat="server" onfocus="WdatePicker()" class="input_select"></asp:TextBox>
            ...
            <asp:LinkButton ID="LinkButton4" runat="server" class="easyui-linkbutton" iconcls="icon-print"
                OnClick="daochu_Click"> 导出Excel </asp:LinkButton>
        </fieldset>
    </div>
    <div class="dataTable">
