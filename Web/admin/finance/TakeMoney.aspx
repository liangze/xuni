...
<body>
    ...
    <div class="box box_width">
        <div class="operation">
            ...
            <asp:LinkButton ID="lbtnDraw" runat="server" class="easyui-linkbutton" iconcls="icon-search"
                OnClick="lbtnDraw_Click"> 提现记录 </asp:LinkButton>
        </div>
        <div class="operation">
                    ...
                    <ItemTemplate>
                        <tr>
                           ...
                           <td align="center">
                            ...
                            <td align="center">
                                <asp:LinkButton ID="lbtnConfirm" CommandArgument='<%# Eval("ID") %>' CommandName="Open"
