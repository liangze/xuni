<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseExam.aspx.cs" Inherits="Web.admin.finance.PurchaseExam" %>
            ...
            <div class="dataTable">
                <fieldset class="fieldset">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="">
                        ...
                        <tr>
                            <td style="text-align: right;">卖家姓名：
                            </td>
                            <td align="left">
                        ...
                        <tr>
                            <td style="text-align: right;">求购数量：
                            </td>
                            <td align="left">
                        ...
                        <tr>
                            <td style="text-align: right;">商品价格：
                            </td>
                            <td align="left">
                        ...
                        <tr>
                            <td width="200" align="right">买家信誉等级：
                            </td>
                            <td align="left">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:LinkButton ID="lbtnExam" runat="server" Text="审 核" class="easyui-linkbutton" iconcls="icon-ok" OnClick="lbtnExam_Click"></asp:LinkButton>&nbsp;&nbsp;
