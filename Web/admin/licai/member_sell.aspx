<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="member_sell.aspx.cs" Inherits="Web.admin.licai.member_sell" %>
    ...
    <asp:LinkButton ID="LinkButton1" runat="server" class="easyui-linkbutton"   
                ...
                <div class="operation">
                    <fieldset class="fieldset">
                        ...
                        <input name="Add_sscFd7" id="txtMaichuCode"  class="input_select"  runat="server" type="text" />&nbsp;&nbsp;&nbsp;
                    ...
                    iconcls="icon-search" onclick="btnMaichu_Click" > 搜 索 </asp:LinkButton>
                    </fieldset>
                </div>
        <div class="dataTable">
