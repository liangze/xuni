<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="member_jiaoyijilu.aspx.cs" Inherits="Web.admin.licai.member_jiaoyijilu" %>
    ...
    <asp:LinkButton ID="LinkButton1" runat="server" class="easyui-linkbutton"   
                ...
                <div class="operation">
                    <fieldset class="fieldset">
                        ...
                        <input name="Add_sscFd7" id="txtDaiCode"  class="input_select"  runat="server" type="text" />&nbsp;&nbsp;&nbsp;
