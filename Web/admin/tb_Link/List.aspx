...
<body>
    ...
    <fieldset class="fieldset">
        ...
        <asp:LinkButton ID="lbtnAdd" runat="server" class="easyui-linkbutton" OnClick="lbtnAdd_Click">添加链接</asp:LinkButton>
    </fieldset>
    <div class="dataTable">
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <asp:LinkButton ID="LinkButton1" runat="server" class="easyui-linkbutton" PostBackUrl='<%#Eval("ID","Add.aspx?id={0}&Link001=1") %>'>编辑</asp:LinkButton>
                            <%--   <asp:LinkButton ID="LinkButton2" runat="server" class="easyui-linkbutton"
                                    PostBackUrl='<%#Eval("ID","delete.aspx?id={0}&p=list.aspx") %>'>删除</asp:LinkButton>--%>
                            <a href="delete.aspx?id=<%#Eval("ID") %>&p=List" class="easyui-linkbutton">删除</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
