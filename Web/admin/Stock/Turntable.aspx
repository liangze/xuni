<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Turntable.aspx.cs" Inherits="Web.admin.Stock.Turntable" %>
...
<body>
    ...
    <div class="operation">
        <asp:LinkButton ID="lbtnWithdraw" runat="server" class="easyui-linkbutton" 
            iconcls="icon-search" onclick="lbtnWithdraw_Click"> 转盘记录 </asp:LinkButton>
    </div>
    <div class="operation">
        <fieldset class="fieldset">
            <legend class="legSearch">查询</legend>已转盘：<input name="txtMoney" id="txtMoney" tip=""
            ...
            会员姓名：<input name="txtTrueName" id="txtTrueName" tip="输入会员姓名" class="input_select"
                runat="server" type="text" />
            申请日期：<asp:TextBox ID="txtStar" tip="输入转盘日期" runat="server" onfocus="WdatePicker()"
                class="input_select"></asp:TextBox>
            至<asp:TextBox ID="txtEnd" tip="输入转盘日期" runat="server" onfocus="WdatePicker()" class="input_select"></asp:TextBox>
