<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TakeMoneyDetail.aspx.cs" Inherits="Web.admin.Stock.TakeMoneyDetail" %>
...
<body>
    ...
    <div class="operation">
        ...
        <asp:LinkButton ID="lbtnWithdraw" runat="server" class="easyui-linkbutton" 
            iconcls="icon-search" onclick="lbtnWithdraw_Click"> 提现记录 </asp:LinkButton>
    </div>
    <div class="operation">
