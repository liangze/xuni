    ...
    <form id="form1" runat="server">
        ...
        <div class="dataTable">
            <table width="99%" border="0" cellspacing="0" cellpadding="0" class="t1">
                ...
                <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound"> <%--OnItemCommand="Repeater1_ItemCommand" OnItemDataBound="Repeater1_ItemDataBound"--%>
                    <ItemTemplate>
                        <tr>
                            <td align="center">
                                <%#Eval("UserCode")%>
