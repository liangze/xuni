...
namespace Library
{
    public class CacheHelper
    {
        ...
        public static void Insert_s(string key, object obj, int Second)
        {
            HttpContext.Current.Cache.Insert(key, obj, null, Cache.NoAbsoluteExpiration, TimeSpan.FromSeconds(Second));
        }
        /// <summary>
        /// 获取缓存对象
        /// </summary>
